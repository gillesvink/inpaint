...
Lets have this image of the frog I recently photographed. Unfortunately, some text has been burned into the image which I desperately want to remove:

| Damaged image           |  Mask                   |
|-------------------------|-------------------------|
| ![Frog](./test/images/baked/frog.png) | ![Mask](./test/images/mask/text.png) |
...
| Result                  |
|-------------------------|
| ![Result](./test/images/expected/telea/frog_text.png) |
...
```rust
use inpaint::prelude::*;
let mut image = image::open("./test/images/input/frog.png").unwrap().to_rgba32f();
...
image = Image.open("./test/images/input/frog.png")
